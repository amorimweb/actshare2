...
$routes = [
    ...
    ['GET',    'admin/exame-perguntas',      __DIR__ . '/admin/exame_perguntas.php'],
    ['POST',   'admin/exame-perguntas',      __DIR__ . '/admin/exame_perguntas.php'],
    ['DELETE', 'admin/exame-perguntas/:id',  __DIR__ . '/admin/exame_perguntas_item.php'],
    ...
    ['GET',    'aluno/exame/:exame_curso_id', __DIR__ . '/aluno/exame.php'],
    ['POST',   'aluno/exame/:tentativa_id/finalizar', __DIR__ . '/aluno/exame_finalizar.php'],
    ...
    ['POST',   'admin/pedidos',        __DIR__ . '/admin/pedidos.php'],
    ...
    ['POST',   'admin/clientes',       __DIR__ . '/admin/clientes.php'],
    ...
    ['GET',    'admin/alunos/:matricula_id/provas', __DIR__ . '/admin/alunos_provas.php'],
    ['GET',    'configuracoes/desconto-progressivo', __DIR__ . '/configuracoes/desconto-progressivo.php'],
    ['GET',    'admin/email-templates', __DIR__ . '/admin/email_templates.php'],
    ['PUT',    'admin/email-templates/:chave', __DIR__ . '/admin/email_templates_item.php'],

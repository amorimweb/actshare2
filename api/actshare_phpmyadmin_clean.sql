...
DROP TABLE IF EXISTS `aulas`, `categorias`, `cupons`, `cupons_indicacao`, `cursos`, `instrutores`, `itens_pedido`, `matriculas`, `membros_organizacao`, `modulos`, `opcoes`, `organizacoes`, `pedidos`, `perguntas`, `proctoring_logs`, `progresso_aula`, `quiz_perguntas_sorteadas`, `quiz_resposta`, `sessoes`, `usuarios`;
